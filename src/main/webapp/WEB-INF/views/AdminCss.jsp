...
<style>
/* Custom CSS for Sidebar (Original Colors) */
...
.sidebar-nav .nav-link.active {
    background-color: #e9ecef; /* Light gray active background */
    color: #000; /* Dark text color for active item */
}
...
.sidebar-nav .nav-content .nav-link {
    padding: 8px 20px; /* Smaller padding for dropdown items */
